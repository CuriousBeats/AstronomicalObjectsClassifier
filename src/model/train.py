...
train_dataset = ImageDataset(root=data_dir + processed_dir + 'train', transform=data_transform)
test_dataset = ImageDataset(root= data_dir + processed_dir + 'test', transform=data_transform) 
val_dataset = ImageDataset(root= data_dir + processed_dir + 'val', transform=data_transform)
